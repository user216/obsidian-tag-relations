...
- Starting-point column listing every tag, collapsible, on either side, one click to centre
- That column arranges flat or grouped by main-tag, switched from its own heading
...
- 565 tests across 92 suites (`npm test`)
