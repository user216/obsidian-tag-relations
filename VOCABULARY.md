...
- **Zen mode** — chrome hidden (toolbar, action bar, side panel), the views themselves untouched. A presentation override rather than a settings change, so leaving it restores what was there.
